...
<?php echo ($page); ?>
    ...
    <div class="list-group" id="category">
        <a href="" class="list-group-item"><span class="badge"><?php echo ($title); ?></span>tag1</a>
        <a href="" class="list-group-item"><span class="badge">1</span>tag2</a>
        <a href="" class="list-group-item"><span class="badge">1</span>tag3</a>
 </div>
